...
Designed to be called from local skills via `exec`.
...
- PORTABLE_SKILLS_WORKSPACE / AGENT_SKILLS_WORKSPACE / OPENCLAW_WORKSPACE:
...
def _default_workspace() -> pathlib.Path:
    return default_workspace_root(pathlib.Path(__file__).resolve())
